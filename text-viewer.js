(function (global) {
  ...
  const styleText = `
    ...
    .line-row-color-0 .line-content { color: lightpink; }
    .line-row-color-1 .line-content { color: #ffee99; }
    .line-row-color-2 .line-content { color: lightgreen; }
    .line-row-color-3 .line-content { color: lightyellow; }
    .line-row-color-4 .line-content { color: cyan; }
    .line-row-color-5 .line-content { color: #ffddee; }
    .line-row-color-6 .line-content { color: #ffcc99; }
  ...
  const start = (options = {}) => {
    ...
    versionElement.classList.add("viewer-version");
    versionElement.textContent = `v${VIEWER_VERSION}`;

    let modifiedElement = document.querySelector("[data-document-modified]");
    if (!modifiedElement) {
      modifiedElement = document.createElement("div");
      modifiedElement.dataset.documentModified = "";
      modifiedElement.setAttribute("aria-label", "Дата и время изменения текста");
